...
// Parse existing prize pool for editing
...
<form method="post" enctype="multipart/form-data" class="form-card multi-step" data-competition-form>
    ...
    <section class="step-panel active" data-step-panel>
        ...
        <div class="grid grid-3">
            <div class="form-group"><label for="first_place_prize">First Place Prize</label><input type="text" id="first_place_prize" name="first_place_prize" placeholder="e.g., $500" value="<?= e($prizes['first'] ?? '') ?>"></div>
            <div class="form-group"><label for="second_place_prize">Second Place Prize</label><input type="text" id="second_place_prize" name="second_place_prize" placeholder="e.g., $300" value="<?= e($prizes['second'] ?? '') ?>"></div>
            <div class="form-group"><label for="third_place_prize">Third Place Prize</label><input type="text" id="third_place_prize" name="third_place_prize" placeholder="e.g., $100" value="<?= e($prizes['third'] ?? '') ?>"></div>
        </div>
